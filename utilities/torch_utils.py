...
# Modified on 30/06/2022
"""
PyTorch utils: this contains code that optimize specific Torch functionalities to work better with Yolo.
"""
...
from utilities.general import file_date, git_describe
...
# logger = Logger('yolo.torch_utils')
